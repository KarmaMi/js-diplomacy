...
class Rule {
   ...
   * @param {!Set.<rule.Order>} orders - The set of orders to be resolved.
   * @return {!Object} -
   *   The return value has a 'result' property, which is an instance of {@link rule.resolved-result}
   *   if the orders were correctly resolved. It has an err property if any errors have occurred.
   */
