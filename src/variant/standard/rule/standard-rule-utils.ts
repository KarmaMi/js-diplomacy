...
export class StandardRuleUtils {
   ...
   */
  static isSea<Power> (map: DiplomacyMap<Power>, province: Province<Power>): boolean {
  ...
  static locationsToRetreat<Power> (
    board: Board<Power>, unit: Unit<Power>, attackedFrom: Province<Power>
  ): Set<Location<Power>> {
    return new Set(
  ...
  static isMovableViaSea<Power> (
    map: DiplomacyMap<Power>, source: Province<Power>, destination: Province<Power>,
    ...
    function dfs (province: Province<Power>): boolean {
      const nextProvinces =
  ...
  static movableLocationsOf<Power> (board: Board<Power>, unit: Unit<Power>): Set<Location<Power>> {
    ...
    const visited = new Set()
    // TODO duplicated code
    function dfs (province: Province<Power>) {
      const nextProvinces =
